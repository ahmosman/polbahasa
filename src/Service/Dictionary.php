...
class Dictionary
{
    ...
    public function getForeignData(array $words): array
    {
        ...
        if (!empty($words)) {
            ...
            foreach ($words as $word) {
                array_push(
                    $foreignData['wordsSections'],
                    $this->getSpeechSections($word)
                );
            }
        }
        return $foreignData;
    ...
    public function getNotFlushedMeaningName(
        array $newMeaningNames,
        string $name
    ) {
